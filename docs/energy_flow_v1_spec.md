...
- EOS-PV-Summary unter `0_userdata.0.EOS.PV.Summary.*`; `PV.Power` ist der reine Anzeigewert aus AC plus RS450-DC
- zukuenftige freigegebene EOS-Lesesicht fuer House
