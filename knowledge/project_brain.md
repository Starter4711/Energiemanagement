...
- `Grid_Flow_V1.js`: implementierte, live validierte und dauerhaft aktive read-only EOS-Grid-Sicht fuer Victron Grid 40 (alte Wohnung), Grid 41 (Halle) und Grid 43 (Haus); Grid 42 ist ausgeschlossen. Die Anbindung an `Energy_Flow_V1` erfolgt erst nach eigener Freigabe.
