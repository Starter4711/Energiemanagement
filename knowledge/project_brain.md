...
- `Grid_Flow_V1.js`: implementierte, noch deaktivierte read-only EOS-Grid-Sicht fuer Victron Grid 40 (alte Wohnung), Grid 41 (Halle) und Grid 43 (Haus); Grid 42 ist ausgeschlossen. Aktivierung und Anbindung an `Energy_Flow_V1` erfolgen erst nach Live-Test und fachlichem Review.
