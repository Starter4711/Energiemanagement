...
- `PV_Flow_V1.js`: dauerhaft aktive read-only Verdichtung von vier AC-Wechselrichtern und zwei RS450-Strings mit getrennten AC-, DC- und Gesamt-Anzeigewerten. Version 1.0.1 und die aktive Anbindung an `Energy_Flow_V1` 1.3.0 sind live validiert; RS450-Leistung bleibt reine DC-Batterieladung.
